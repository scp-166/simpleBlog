...
Message.prototype.initElement = function () {
    var self = this;
    self.wrapper = $("<div></div>");	// 新建一个div来显示信息
    self.wrapper.css({
        'padding': '10px',
        'font-size': '14px',
        'width': '300px',
        'position': 'fixed',
        'z-index': '10000', // sweetalert的mask-header的z-index是1030,提升到最高避免被覆盖
        'left': '50%',
        'top': '-48px',
        'margin-left':'-150px',
        'height': '48px',
    ...
    self.messageSpan = $("<span class='result-message-group'></span>");
...
window.messageBox = new Message();	// 绑定到window中